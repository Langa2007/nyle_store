...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-blue-50 p-4 pt-20">
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-gray-800">
            <Image
              ...
              height={40}
              priority
              className="h-10 w-10 drop-shadow-[0_10px_22px_rgba(245,158,11,0.22)]"
            />
            <div className="text-lg font-semibold">Nyle Store</div>
          </div>
        </div>
