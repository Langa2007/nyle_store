...
router.post('/vendor/auth/verify-reset-code', passwordResetLimiter, (req, res) => {
    req.body.user_type = 'vendor';
    return verifyResetCode(req, res);
});

// 3. Reset password - uses token from verified code to set new password
router.post('/vendor/auth/reset-password', passwordResetLimiter, (req, res) => {
    req.body.user_type = 'vendor';
    return resetPassword(req, res);
});

// 4. Resend reset code - sends new 6-digit code
router.post('/vendor/auth/resend-reset-code', passwordResetLimiter, (req, res) => {
    req.body.user_type = 'vendor';
...
router.post('/auth/verify-reset-code', passwordResetLimiter, (req, res) => {
    req.body.user_type = 'user';
    return verifyResetCode(req, res);
});
...
router.post('/auth/resend-reset-code', passwordResetLimiter, (req, res) => {
    req.body.user_type = 'user';
    return resendResetCode(req, res);
});
